...
export const Dashboard = () => {
  ...
  const addQueryParam = (convoId: string) => {
    const currentURL = new URL(window.location.href);

    // Add a new query parameter
    currentURL.searchParams.set("convoId", convoId);
  ...
  return botpressClient ? (
    ...
    <LoginPage
      clearsCredentialsAndClient={clearsCredentialsAndClient}
      heading="User Name"
      subheading="Password"
    />
  );
